...
- **Fuzzy match + HITL override — `terragreen_TG-2026-1505.csv`.** [Pre-approval trace](https://smith.langchain.com/public/6e22a229-c3fe-4f5a-b763-57ce00a18725/r) · [Post-resume trace](https://smith.langchain.com/public/ff48a322-2934-40dc-80d7-f874ed6018bc/r). Five deliberate SKU typos exercise tiers 3–4 of the cascade — the pre-approval trace shows the fuzzy fallthrough (one of which lands on the wrong sibling SKU at low confidence). The post-resume trace shows the human-chosen override arriving via the decision payload and `_flag_one` re-running against the override product before the line goes downstream.
